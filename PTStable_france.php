          ...
          <div class="wide3 nav2">
            <div class="row">
                <div class="span1 span_row">
	                ...
	                <div class="nav_item_spliter"></div>
	                <!--更改此处层叠样式表-->
	                <a href="PTStable_france.php"><div class="nav_item active">积分榜</div></a>
          ...
          <div class="wide3" style="padding-top: 30px;">
			<div class="row">
				<div class="span9 bread span_row">
					<a href="main.php">首页</a> > <a href="PTStable_france.php">积分榜</a>
				</div>
			</div>
          	...
          	<div class="grid-row clearfix">
          		<div class="grid-150 fl mr20">
					<ul class="side-nav-bd">
						...
						<li class="fuck"><a href="PTStable_germany.php">德甲</a></li>
						<li class="fuck"><a class="current" href="PTStable_france.php">法甲</a></li>
